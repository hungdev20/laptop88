    ...
    <div id="content" class="container-fluid">
        <div class="card">
            ...
            <div class="card-body row">
                <form action="<?php echo e(route('role.store')); ?>" method="POST" id="add_role" enctype="multipart/form-data">
                    <?php echo csrf_field(); ?>
                    <div class="col-md-12">
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp-1\htdocs\hunganh_newest\resources\views/admin/role/add.blade.php ENDPATH**/ ?>