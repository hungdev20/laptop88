        ...
        <div class="card">
            ...
            <div class="card-body">
                <div class="analytic">
                    ...
                    <a href="<?php echo e(request()->fullUrlWithQuery(['status' => 'processing'])); ?>" class="text-primary">Đang xử
                        lý<span class="text-muted">(<?php echo e($data[2]); ?>)</span></a>
                    <a href="<?php echo e(request()->fullUrlWithQuery(['status' => 'transporting'])); ?>" class="text-primary">Đang
                        giao<span class="text-muted">(<?php echo e($data[3]); ?>)</span></a>
                    <a href="<?php echo e(request()->fullUrlWithQuery(['status' => 'success'])); ?>" class="text-primary">Hoàn
                        thành<span class="text-muted">(<?php echo e($data[4]); ?>)</span></a>
                    <a href="<?php echo e(request()->fullUrlWithQuery(['status' => 'cancel'])); ?>" class="text-primary">Hủy đơn
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp-1\htdocs\laravelpro\hunganh_shop\resources\views/admin/order/index.blade.php ENDPATH**/ ?>