                ...
                <div class="section post-about-pro">
                        ...
                        <?php $__currentLoopData = $post_vertical; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $post): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <li class=" col-lg-3 col-md-4 col-sm-6">
                                <div class="card-post">
                                    ...
                                    <div class="cp-body">
                                        <a href="<?php echo e(route('post_detail', [$post->slug, $post->id])); ?>"
                                            class="post-name d-block"> <?php echo e(Str::of($post->post_title)->limit(58)); ?>
                    ...
                    <div id="post-horizon">
                        ...
                        <div id="pagination" class="text-center">
                            <?php
                                echo get_pagging($num_page, $page, route('posts'));
                            ?>
                        </div>
...
<?php echo $__env->make('layouts.client', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp-1\htdocs\laravelpro\hunganh_shop\resources\views/client/posts/index.blade.php ENDPATH**/ ?>