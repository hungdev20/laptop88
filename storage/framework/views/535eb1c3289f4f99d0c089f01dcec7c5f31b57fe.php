                ...
                <form action="<?php echo e(route('store.post')); ?>" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control" type="text" name="post_title" id="post_title"
                            value="<?php echo e(request()->old('post_title')); ?>">
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="content" class="form-control" id="content" cols="30"
                            rows="10"><?php echo e(request()->old('content')); ?></textarea>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp-1\htdocs\laravelpro\hunganh_shop\resources\views/admin/post/add.blade.php ENDPATH**/ ?>