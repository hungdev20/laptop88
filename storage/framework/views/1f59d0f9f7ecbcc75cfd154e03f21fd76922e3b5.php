    ...
    <div id="main-content-wp" class="wp-homepage">
        <div id="wp-inner" class="container">
            <div id="main-content">
                ...
                <?php endif; ?>
                <div class="section banner-under-product-hot d-flex justify-content-between wow bounceInUp">
                    <a href="">
                ...
                <?php if(!empty($tivi)): ?>
                    <div class="section home-pro-hot box-pro-container wow bounceInUp">
                        <div class="box-title-container">
                            <h2 class="box-title">
                                Tivi - Màn hình Tivi
                            </h2>
                        ...
                        <ul class="product-container row mt-3">
                            <?php $__currentLoopData = $tivi; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $itemTivi): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <li class="col-md-3 col-sm-6">
                                    <div class="card-prd">
                                        <a href="<?php echo e(route('productDetail', [$itemTivi->slug, $itemTivi->id])); ?>"
                                            class="pro-thumb d-block">
                                            <img src="<?php echo e(url($itemTivi->thumbnail)); ?>" alt="" class="d-block">
                                        </a>
                                        <div class="cprd-body">
                                            <a href="<?php echo e(route('productDetail', [$itemTivi->slug, $itemTivi->id])); ?>"
                                                class="pro-name d-block">
                                                <?php echo e(Str::of($itemTivi->product_title)->limit(50)); ?> </a>
                                            <span
                                                class="pro-price text-center"><?php echo e(number_format($itemTivi->price, 0, ',', '.')); ?>đ</span>
                                            <div class="clearfix">
                        ...
                        <div class="text-center mt-3">
                            <a href="<?php echo e(route('productCat', ['tivi-man-hinh-tv', 87])); ?>"
                                class="view-all d-inline-block">Xem tất
                                cả sản phẩm</a>
                        </div>
                    </div>
                <?php endif; ?>
                ...
                <?php if(!empty($smart)): ?>
                    <div class="section elect-components box-pro-container wow bounceInUp">
                        <div class="box-title-container">
                            <h2 class="box-title">
                        ...
                        <ul class="product-container row mt-3">
                            <?php $__currentLoopData = $smart; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $itemSmart): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <li class="col-md-3">
                                    <div class="card-prd">
                                        <a href="<?php echo e(route('productDetail', [$itemSmart->slug, $itemSmart->id])); ?>"
                                            class="pro-thumb d-block">
                ...
                <?php if(!empty($component)): ?>
                    <div class="section component box-pro-container wow bounceInUp">
                        <div class="box-title-container">
                            <h2 class="box-title">
                                Link kiện PC
                            </h2>
                        ...
                        <ul class="product-container row mt-3">
                            <?php $__currentLoopData = $component; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $itemComponent): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <li class="col-md-3">
                                    <div class="card-prd">
                                        <a href="<?php echo e(route('productDetail', [$itemComponent->slug, $itemComponent->id])); ?>"
                                            class="pro-thumb d-block">
                                            <img src="<?php echo e(url($itemComponent->thumbnail)); ?>" alt=""
                                                class="d-block">
                                        </a>
                                        <div class="cprd-body">
                                            <a href="<?php echo e(route('productDetail', [$itemComponent->slug, $itemComponent->id])); ?>"
                        ...
                        <div class="text-center mt-3">
                            <a href="<?php echo e(route('productCat', ['link-kien-pc', 69])); ?>" class="view-all d-inline-block">Xem
                                tất
                                cả sản phẩm</a>
                        </div>
                    </div>
...
<?php echo $__env->make('layouts.client', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp-1\htdocs\hunganh_newest\resources\views/client/home/index.blade.php ENDPATH**/ ?>