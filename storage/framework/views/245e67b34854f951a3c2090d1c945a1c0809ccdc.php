        ...
        <div class="row">
            <div class="col-4">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="<?php echo e(route('update.menu', $menu_info->id)); ?>" method="POST" enctype="multipart/form-data">
                            <?php echo csrf_field(); ?>
                            <div class="form-group">
                                <label for="menu_title">Tên menu</label>
                                <input class="form-control" type="text" name="menu_title" id="menu_title" value="<?php echo e($menu_info->menu_title); ?>">
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" type="text" name="slug" id="slug" value="<?php echo e($menu_info->slug); ?>">
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" type="text" name="icon" id="icon" value="<?php echo e($menu_info->icon); ?>">
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control" name="pages" id="">
                                    ...
                                    <?php $__currentLoopData = $list_pages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $k => $v): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($v->id); ?>" <?php if($menu_info->page_id == $v->id): ?>
                                            selected
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control" name="product_cats" id="product_cats">
                                    ...
                                    <?php $__currentLoopData = $list_procats; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $k => $v): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($v->id); ?>" <?php if($menu_info->productcat_id == $v->id): ?>
                                            selected
                                        <?php endif; ?>>
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control" name="post_cats" id="post_cats">
                                    ...
                                    <?php $__currentLoopData = $list_postcats; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $k => $v): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($v->id); ?>" <?php if($menu_info->postcat_id == $v->id): ?>
                                            selected
                                        <?php endif; ?>>
                                            <?php echo e(str_repeat('--', $v->level) . $v->cat_title); ?>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="" name="order" id="order"
                                    value="<?php echo e($menu_info->order); ?>">
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="status" id="exampleRadios1" value="passive" <?php if($menu_info->status == 'passive'): ?> checked <?php endif; ?>>
                                <label class="form-check-label" for="exampleRadios1">
                                    Chờ duyệt
                                </label>
                            </div>
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="status" id="exampleRadios2" value="active" <?php if($menu_info->status == 'active'): ?> checked <?php endif; ?>>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp-1\htdocs\laravelpro\hunganh_shop\resources\views/admin/menu/edit.blade.php ENDPATH**/ ?>