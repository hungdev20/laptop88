    ...
    <div class="container-fluid py-5">
        ...
        <div class="row">
            ...
            <div class="col-md-4">
                ...
                <a href="<?php echo e(route("inventory")); ?>" class="card text-white bg-primary mb-3" style="max-width: 18rem; cursor: pointer;">

                    <div class="card-header">HÀNG TỒN</div>

                    <div class="card-body">

                        <h5 class="card-title"><?php echo e($inventory); ?></h5>
            ...
            <div class="col-md-4">
                ...
                <a href="<?php echo e(route("stockout")); ?>"  class="card text-white bg-danger mb-3" style="max-width: 18rem; cursor: pointer;">

                    <div class="card-header">HẾT HÀNG</div>

                    <div class="card-body">

                        <h5 class="card-title"><?php echo e($stockout); ?></h5>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp-1\htdocs\Laptop88\resources\views/admin/dashboard.blade.php ENDPATH**/ ?>