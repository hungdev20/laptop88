                    ...
                    <div class="section" id="detail-product-wp">
                        ...
                        <div class="box-right sell-policy">
                          ...
                          <div id="facebook" class="d-flex" style="padding-left: 21px">
                           <div class="fb-like" data-href="<?php echo e($url_canonical); ?>" style="margin-right: 10px;margin-top: 4px;" data-width="" data-layout="button" data-action="like" data-size="small" data-share="false"></div>
                           <div class="fb-share-button" data-href="<?php echo e($url_canonical); ?>" data-layout="button" data-size="small"><a target="_blank" href="https://www.facebook.com/sharer/sharer.php?u=<?php echo e($url_canonical); ?>" class="fb-xfbml-parse-ignore">Chia sẻ</a></div>
                             </div>
...
<?php echo $__env->make('layouts.client', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/manhhungunitopcv/public_html/resources/views/client/product/index.blade.php ENDPATH**/ ?>