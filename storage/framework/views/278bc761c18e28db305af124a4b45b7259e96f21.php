        ...
        <?php $__currentLoopData = $paraChildren; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $childItem): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            ...
            <div class="item col-md-6 mb-1">
                ...
                <input type="checkbox" class="form-check-input op<?php echo e($t); ?>" id="<?php echo e($childItem->para_title); ?>"
                    name="<?php echo e($paraEng); ?>[]" <?php $__currentLoopData = $op; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $opHA): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
<?php /**PATH D:\xampp-1\htdocs\laravelpro\hunganh2\resources\views/layouts/client-sidebar-1.blade.php ENDPATH**/ ?>