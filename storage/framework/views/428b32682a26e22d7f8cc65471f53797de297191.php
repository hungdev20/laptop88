                    ...
                    <div class="inf_2">
                        ...
                        <div class="stardust-dropdown">
                            <div class="stardust" style="font-size: 17px">
                                ...
                                <?php endif; ?>"><span>Hồ
                                        sơ</span></a>
                                <a href="" class="changePass d-block"><span>Đổi mật khẩu</span></a>
                            </div>
                        </div>
...
<?php echo $__env->make('layouts.client', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp-1\htdocs\laravelpro\hunganh_shop\resources\views/layouts/account.blade.php ENDPATH**/ ?>