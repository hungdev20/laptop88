...
<head>
    ...
    <link rel="icon" type="image/x-icon"
        href="https://laptop88.vn/template/template_2019/images/favicon1.png" />
        ...
        <div id="container">
            <div id="header-wp">
                ...
                <div id="head-body" class="clearfix">
                    <div class="wp-inner container">
                        <a href="<?php echo e(url('/')); ?>" title="" id="logo" class="fl-left"><img style="height:60px"
                                src="<?php echo e(url('public/client/images/logo-new.png')); ?>" /></a>
            ...
            <div id="footer-wp">
                <div id="navSocial">
                    <div class="social">
                        <ul>
                            <li><a href=" <?php if(!empty($facebook_link)): ?>
                                    <?php echo e($facebook_link); ?>
                ...
                <div class="col-content d-flex">
                    ...
                    <div>
                        <h4>Tổng đài</h4>
                        <a class="hotline" href="tel:0399809731"><?php if(!empty($phone_contact)): ?>
                            <?php echo e($phone_contact); ?>
...
<?php /**PATH D:\xampp-1\htdocs\TungHaiPc\resources\views/layouts/client.blade.php ENDPATH**/ ?>