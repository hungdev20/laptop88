...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="form-group">
                                ...
                                <textarea name="catProDesc" class="form-control textarea" id="catProDesc" cols="30"
                                    ...
                                    rows="5"><?php echo e($product_info->meta_desc); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="form-group">
                                ...
                                <textarea name="catProKeywords" class="form-control textarea" id="catProKeywords" cols="30"
                                    ...
                                    rows="5"><?php echo e($product_info->meta_keywords); ?></textarea>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp-1\htdocs\laravelpro\hunganh\resources\views/admin/product/edit.blade.php ENDPATH**/ ?>