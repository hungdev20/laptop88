                ...
                <form action="<?php echo e(route('store.slider')); ?>" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control" type="text" name="slider_title" id="slider_title"
                            value="<?php echo e(request()->old('slider_title')); ?>">
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="" name="order" id="order" value="<?php echo e(request()->old('order')); ?>">
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp-1\htdocs\laravelpro\hunganh_shop\resources\views/admin/slider/add.blade.php ENDPATH**/ ?>