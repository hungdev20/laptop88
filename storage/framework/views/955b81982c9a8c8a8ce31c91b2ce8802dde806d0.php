    ...
    <div id="content" class="container-fluid">
        <div class="card">
            ...
            <div class="card-body">
                ...
                <form action="<?php echo e(route('post_cat.action')); ?>" method="POST">
                    <?php echo csrf_field(); ?>
                                ...
                                <?php $__currentLoopData = $post_cat; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    ...
                                    <tr>
                                        ...
                                        <?php if(Auth::id() == $cat->user_id): ?>
                                            <td>
                                                <a href="<?php echo e(route('edit.post_cat', $cat->id)); ?>"
                                                    class="btn btn-success btn-sm rounded-0 text-white" type="button"
                                                    data-toggle="tooltip" data-placement="top" title="Edit"><i
                                                        class="fa fa-edit"></i></a>
                                                <?php if($status != 'trash'): ?>
                                                    <a href="<?php echo e(route('delete.post_cat', $cat->id)); ?>"
                ...
                <?php echo e($post_cat->appends($append)->links()); ?>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp-1\htdocs\laravelpro\hunganh_shop\resources\views/admin/post_cat/list.blade.php ENDPATH**/ ?>