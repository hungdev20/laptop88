    ...
    <div id="content" class="container-fluid">
        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <form action="<?php echo e(route('cat.action')); ?>" method="POST">
                            ...
                            <?php if($product_cat->total() > 0): ?>
                                ...
                                <?php $__currentLoopData = $product_cat; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    ...
                                    <tr>
                                        ...
                                        <td><a href=""><?php echo e($cat->cat_title); ?></a></td>
                                        <?php
                                            $catParentName = Product_cat::find($cat->parent_id);
                                            
                                        ?>

                                        <td>
                                            <?php if(!empty($catParentName)): ?>
                                                <?php echo e($catParentName->cat_title); ?>
                                ...
                                <?php if(Auth::id() == $cat->user_id): ?>
                                    ...
                                    <td>
                                        ...
                                        <a href="<?php echo e(route('edit.product_cat', $cat->id)); ?>"
                                        ...
                                        <?php if($status != 'trash'): ?>
                                            ...
                                            <a href="<?php echo e(route('delete.product_cat', $cat->id)); ?>"
                ...
                <?php echo e($product_cat->appends($append)->links()); ?>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp-1\htdocs\TungHaiPc\resources\views/admin/product_cat/list.blade.php ENDPATH**/ ?>