...
<head>
    ...
    <script>
        ...
        var editor_config = {
            ...
            path_absolute: "https://manhhung.unitopcv.com/",

            selector: "textarea:not(textarea.textarea)",
            ...
            <div id="sidebar" class="bg-white">
                ...
                <ul id="sidebar-menu">
                    ...
                    <li class="nav-link <?php echo e($module_active == 'permissions' ? 'active' : ''); ?>">
                        ...
                        <a href="<?php echo e(url('permissions/list')); ?>">
                        ...
                        <ul class="sub-menu">
                            ...
                            <li><a href="<?php echo e(url('permissions/add')); ?>">Thêm mới</a></li>

                            <li><a href="<?php echo e(url('permissions/list')); ?>">Danh sách</a></li>
...
<?php /**PATH D:\xampp-1\htdocs\laravelpro\hunganh\resources\views/layouts/admin.blade.php ENDPATH**/ ?>