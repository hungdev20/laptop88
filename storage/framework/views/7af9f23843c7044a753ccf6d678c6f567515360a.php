        ...
        <div id="page-body" class="d-flex">
            <div id="sidebar" class="bg-gr00">
                <ul id="sidebar-menu">
                    ...
                    <li class="nav-link <?php echo e($module_active == 'accounts' ? 'active' : ''); ?>">
                        <a href="<?php echo e(url('admin/accounts/list')); ?>">
                            <div class="nav-link-icon d-inline-flex">
                        ...
                        <i class="arrow fas fa-angle-right"></i>
                        <ul class="sub-menu">
                            <li><a href="<?php echo e(url('admin/accounts/list')); ?>">Danh sách</a></li>
                        </ul>
                    </li>
...
<?php /**PATH D:\xampp-1\htdocs\Laptop88\resources\views/layouts/admin.blade.php ENDPATH**/ ?>