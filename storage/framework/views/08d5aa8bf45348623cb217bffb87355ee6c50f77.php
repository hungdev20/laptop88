                    ...
                    <div class="wp-inner container">
                        ...
                        <div id="search-wp" class="fl-left">
                            <form method="GET" action="<?php echo e(route('search')); ?>" id="search_pr">
                                ...
                                <input type="text" name="s" id="search" value="<?php echo e(request()->input('s')); ?>"
                        ...
                        <div id="action-wp" class="fl-right">
                            ...
                            <div id="cart-wp" class="fl-right">
                                ...
                                <div id="dropdown">
                                    ...
                                    <?php if(Cart::count() == 0): ?>{
                                        <div id="no-prdt-cart">
                                            <img src="<?php echo e(asset('client/images/img-no-prdt-cart.png')); ?>" alt="">
                                        </div>
                                        }
                                    <?php else: ?>
                                        <ul class="list-cart">
                                            <?php $__currentLoopData = Cart::content(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cartItem): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <li class="clearfix">
                                                    <a href="<?php echo e(route('productDetail', [$cartItem->options->slug, $cartItem->id])); ?>"
                                                        ...
                                                        <img src="<?php echo e(url($cartItem->options->thumbnail)); ?>" alt="">
                                                    </a>
                    ...
                    <div class="container">
                        <div class="d-flex align-items-center">
                            <div class="head-menu-container">
                                ...
                                <div class="header-menu-holder pt-1" <?php if(empty(session('page_current'))): ?>
                                    id="wp-hide"
                                    <?php endif; ?>>
            ...
            <div id="footer-wp">
                <div class="col-content d-flex">
                    <div class="link-content">
                        ...
                        <ul>
                            <li>
                                <a href="<?php echo e(route('pages',['doi-tra-mien-phi',1])); ?>">Đổi trả miễn phí</a>
                            </li>
                            <li>
                                <a href="<?php echo e(route('pages',['mien-phi-van-chuyen',2])); ?>">Miễn phí vận chuyển</a>
                            </li>
                            <li>
                                <a href="<?php echo e(route('pages',['huong-dan-mua-tra-gop',4])); ?>">Mua hàng trả góp</a>
                            </li>
                            <li>
                                <a href="<?php echo e(route('pages',['huong-dan-mua-hang-online',3])); ?>">Hướng dẫn mua hàng online</a>
                            </li>
                            <li>
                    ...
                    <div>
                        <h4>Tổng đài</h4>
                        <a class="hotline" href="tel:0399809731">0399.809.731</a>
                    </div>
                    <div>
                ...
                <div class="info_footer">
                    <p>© 2020. CÔNG TY CỔ PHẦN XÂY DỰNG VÀ ĐẦU TƯ THƯƠNG MẠI HUNGANH. MST:  0399809731. (Đăng ký lần đầu: Ngày 15 tháng 09 năm 2021, Đăng ký thay đổi ngày 07/10/2021)</p>
                    <p><strong>GP số 426/GP-TTĐT do sở TTTT Hà Nội cấp ngày 22/01/2021</strong></p>
                    <p>Địa chỉ: 26 Lương Thế Vinh, Đ.Nguyễn Trãi, Q. Thanh Xuân, Hà Nội. Điện thoại: 0399809731 Chịu trách nhiệm nội dung: <strong>Phan Văn Tùng</strong>. </p>
                    <p>Designed by: <strong>John Cenas</strong> @johncenas.design</p>
                </div>
                <div id="btn-top"><img src="<?php echo e(url('public/client/images/icon-to-top.png')); ?>" alt="" /></div>
                <div id="fb-root"></div>
            </div>
            <div id="menu-respon">
                <a href="?page=home" title="" class="logo">HASHOP</a>
                <div id="menu-respon-wp">
                    ...
                    <div id="pageResponse">
                        ...
                        <ul class="___class_+?157___" id="main-menu-respon">
                            <?php $__currentLoopData = $menus; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $menu): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <li>
                                    <a href="<?php echo e(route('pages', [$menu->slug, $menu->id])); ?>"
                                        title><?php echo e($menu->menu_title); ?></a>
                    ...
                    <div id="postResponse">
                        ...
                        <ul class="___class_+?157___" id="main-menu-respon">
                            ...
                            <li>
                                <a href="<?php echo e(route('posts')); ?>" title><?php echo e($menu_blog->menu_title); ?></a>
...
<?php /**PATH D:\xampp-1\htdocs\laravelpro\hunganh_shop\resources\views/layouts/client.blade.php ENDPATH**/ ?>