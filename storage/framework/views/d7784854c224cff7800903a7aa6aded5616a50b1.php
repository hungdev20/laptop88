            ...
            <div id="main-content">
                <div class="section" id="wp-main">
                    ...
                    <div class="ha-col-3 row no-gutters" id="main-advert">
                        <div id="wp-slider" class="col-md-9">
                        ...
                        <div id="wp-banner" class="col-md-3">
                ...
                <div class="section home-pro-hot box-pro-container">
                                ...
                                <div class="cprd-body">
                                    ...
                                    <div class="clearfix">
                                        <a href="" class="add-cart fl-left mt-2 mb-3 btn btn-outline-dark">Thêm giỏ
                                            hàng</a>
                                        <a href="" class="buy-now fl-right mt-2 mb-3 btn btn-outline-danger">Mua ngay</a>
                                    </div>
                                </div>
                            </div>
                        </li>
                    ...
                    <div class="text-center mt-3">
                        <a href="" class="view-all d-inline-block">Xem tất cả sản phẩm</a>
                    </div>
                </div>
                ...
                <?php endif; ?>
                <div class="section apple box-pro-container">
                    <div class="box-title-container">
                        <h2 class="box-title">
                            Apple
                        </h2>
...
<?php echo $__env->make('layouts.client', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp-1\htdocs\laravelpro\hunganh_shop\resources\views/client/home/index.blade.php ENDPATH**/ ?>