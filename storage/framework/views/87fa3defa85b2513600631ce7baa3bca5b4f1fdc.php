                                    ...
                                    <div class="form-group">
                                        <select name="sort" class="form-control" id="sort">
                                            <option value="price-asc" <?php if($sort == 'price-asc'): ?>
                                                selected
                                                <?php endif; ?>>Từ thấp đến cao</option>
                                            <option value="price-desc" <?php if($sort == 'price-desc'): ?>
                                                selected
                                                <?php endif; ?>>Từ cao đến thấp</option>
                                        </select>
                                    </div>
                                </form>
                            </div>
...
<?php echo $__env->make('layouts.client', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp-1\htdocs\hunganh_newest\resources\views/client/product-cat/index.blade.php ENDPATH**/ ?>