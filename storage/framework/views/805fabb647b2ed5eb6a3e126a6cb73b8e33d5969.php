            ...
            <form action="<?php echo e(route('update.profile')); ?>" method="POST" class="row"
                ...
                <div class="col-md-8 left-info">
                    <div class="item row mb-5">
                        ...
                        <div class="col-8">
                            <span><?php echo e($user_info->username); ?></span>
                        </div>
                    </div>
                    <div class="item row mb-5">
                        <div class="col-4">
...
<?php echo $__env->make('layouts.account', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp-1\htdocs\laravelpro\hunganh_shop\resources\views/client/account/profile.blade.php ENDPATH**/ ?>