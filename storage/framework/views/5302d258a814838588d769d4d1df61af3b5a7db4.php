...
<?php $__env->startSection('title', 'Danh mục quyền'); ?>
        ...
        <div class="row">
            <div class="col-4">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="<?php echo e(route('store.permissioncat')); ?>" method="POST" enctype="multipart/form-data">
                            <?php echo csrf_field(); ?>
            ...
            <div class="col-8">
                <div class="card">
                    ...
                    <a href="<?php echo e(Request::url()); ?>?status=trash" class="text-primary">Thùng
                        ...
                        <form action="<?php echo e(route('permissioncat.action')); ?>" method="POST">
                            <?php echo csrf_field(); ?>
                                        ...
                                        <?php $__currentLoopData = $listcat; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            ...
                                            <tr>
                                                ...
                                                <?php if(Auth::id() == $item->user_id): ?>
                                                    <td>
                                                        <a href="<?php echo e(route('edit.permissioncat', $item->id)); ?>"
                                                            class="btn btn-success btn-sm rounded-0 text-white"
                                                            type="button" data-toggle="tooltip" data-placement="top"
                                                            title="Edit"><i class="fa fa-edit"></i></a>
                                                        <?php if($status != 'trash'): ?>
                                                            <a href="<?php echo e(route('delete.permissioncat', $item->id)); ?>"
                        ...
                        <?php echo e($listcat->appends($append)->links()); ?>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp-1\htdocs\hunganh_newest\resources\views/admin/permissioncat/index.blade.php ENDPATH**/ ?>