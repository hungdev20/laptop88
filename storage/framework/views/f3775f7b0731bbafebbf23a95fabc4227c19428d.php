...
<?php $__env->startSection('title', 'Danh sách quyền'); ?>
        ...
        <div class="row">
            <div class="col-4">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="<?php echo e(route('store.permission')); ?>" method="POST" enctype="multipart/form-data">
                            <?php echo csrf_field(); ?>
                            ...
                            <div class="form-group">
                                ...
                                <select name="module_parent" class="custom-select">
                                    ...
                                    <?php $__currentLoopData = $permissionParent; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $moduleItem): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($moduleItem->id); ?>"><?php echo e($moduleItem->name); ?></option>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp-1\htdocs\hunganh_newest\resources\views/admin/permission/index.blade.php ENDPATH**/ ?>