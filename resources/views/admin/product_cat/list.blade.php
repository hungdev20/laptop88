    ...
    <div id="content" class="container-fluid">
        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <form action="{{ route('cat.action') }}" method="POST">
                            ...
                            @if ($product_cat->total() > 0)
                                ...
                                @if (Auth::id() == $cat->user_id)
                                    ...
                                    <td>
                                        ...
                                        <a href="{{ route('edit.product_cat', $cat->id) }}"
                                        ...
                                        @if ($status != 'trash')
                                            ...
                                            <a href="{{ route('delete.product_cat', $cat->id) }}"
                ...
                {{ $product_cat->appends($append)->links() }}
