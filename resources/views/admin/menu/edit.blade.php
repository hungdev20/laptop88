            ...
            <div class="col-4">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ route('update.menu', $menu_info->id) }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" type="text" name="menu_title" id="menu_title" value="{{ $menu_info->menu_title }}">
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" type="text" name="slug" id="slug" value="{{ $menu_info->slug }}">
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" type="text" name="icon" id="icon" value="{{ $menu_info->icon }}">
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control" name="pages" id="">
                                    ...
                                    @foreach ($list_pages as $k => $v)
                                        ...
                                        <option value="{{ $v->id }}" @if ($menu_info->page_id == $v->id)

                                            selected

                                        @endif>{{ $v->page_title }}</option>
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control" name="product_cats" id="product_cats">
                                    ...
                                    @foreach ($list_procats as $k => $v)
                                        ...
                                        <option value="{{ $v->id }}" @if ($menu_info->productcat_id == $v->id)
                            ...
                            <div class="form-check">
                                ...
                                <input class="form-check-input" type="radio" name="status" id="exampleRadios1" value="passive" @if ($menu_info->status == 'passive') checked @endif>
                            ...
                            <div class="form-check">
                                ...
                                <input class="form-check-input" type="radio" name="status" id="exampleRadios2" value="active" @if ($menu_info->status == 'active') checked @endif>
                                    ...
                                    @if ($menu->total() > 0)
                                        ...
                                        @foreach ($menu as $item)
                                            ...
                                            <tr>
                                                ...
                                                <td class="menu_title"><a href="#">{{ $item->menu_title }}</a></td>
