        ...
        <div class="row">
            <div class="col-4">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="{{ route('permission.update', $permission_info->id) }}" method="POST"
                            ...
                            <div class="form-group">
                                ...
                                <select name="module_parent" class="custom-select">
                                    ...
                                    @foreach ($permissionParent as $moduleItem)
                                        <option value="{{ $moduleItem->id }}" @if ($permission_info->parent_id == $moduleItem->id)
                                            selected
                                        @endif>{{ $moduleItem->name }}</option>
                                    @endforeach
                                </select>
                                @error('module_parent')
                                    <small class="form-text text-danger">
            ...
            <div class="col-8">
                <div class="card">
                    ...
                    <a href="{{ Request::url() }}?status=trash" class="text-primary">Thùng
                                    ...
                                    @if ($listpermission->total() > 0)
                                        ...
                                        @foreach ($listpermission as $item)
                                            ...
                                            <tr>
                                                ...
                                                <td class="keycode"><a href="#">{{ $item->key_code }}</a></td>
                        ...
                        {{ $listpermission->appends($append)->links() }}
                    </div>
                </div>
            </div>
        </div>
