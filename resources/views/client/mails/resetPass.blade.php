                                                                                                ...
                                                                                                <tbody>
                                                                                                    ...
                                                                                                    <tr>
                                                                                                        ...
                                                                                                        <td
                                                                                                            ...
                                                                                                            <a href="{{ url('resetpass/' . $reset_token . '?email=' . $email) }}"
                                                                                                                ...
                                                                                                                data-saferedirecturl="https://www.google.com/url?q=https://manhhung.unitopcv.com/resetpass/{{ $reset_token }}?email%3D{{ $email }}&amp;source=gmail&amp;ust=1632360324587000&amp;usg=AFQjCNEY59fQlqf0C33hZeXd5kNbD2_OlA">Reset
                                                                            ...
                                                                            <p
                                                                                ...
                                                                                into your web browser: <span
                                                                                    ...
                                                                                    style="box-sizing:border-box;font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,Helvetica,Arial,sans-serif,'Apple Color Emoji','Segoe UI Emoji','Segoe UI Symbol';word-break:break-all"><a
                                                                                        ...
                                                                                        href="{{ url('resetpass/' . $reset_token . '?email=' . $email) }}"
                                                                                        ...
                                                                                        data-saferedirecturl="https://www.google.com/url?q=https://manhhung.unitopcv.com/resetpass/{{ $reset_token }}?email%3D{{ $email }}&amp;source=gmail&amp;ust=1632360324587000&amp;usg=AFQjCNEY59fQlqf0C33hZeXd5kNbD2_OlA">https://manhhung.unitopcv.com/resetpass/<wbr><wbr>{{ $reset_token }}?email=<wbr>{{ $email }}</a></span>
