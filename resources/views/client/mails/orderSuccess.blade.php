                                                ...
                                                <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                                    <tbody>
                                                        <tr>
                                                            ...
                                                            <td><a href="{{ url('public/client/images/mail-order.jpg') }}"
                                        ...
                                        <tr>
                                            <td>
                                                ...
                                                <h3
                                                    ...
                                                    Thông tin đơn hàng #{{ $code }} <span
                                                        style="font-size:12px;color:#777;text-transform:none;font-weight:normal">({{ $time }})</span>
                                                </h3>
                                            </td>
                                        </tr>
                                        <tr>
                                                    ...
                                                    <tbody>
                                                        <tr>
                                                            <td style="padding:3px 9px 9px 9px;border-top:0;font-family:Arial,Helvetica,sans-serif;font-size:12px;color:#444;line-height:18px;font-weight:normal"
                                                                valign="top"><span
                                                                    style="text-transform:capitalize">{{ $customer_name }}</span><br>
                                                                <a href="mailto:{{ $email }}"
                                                                    rel="noreferrer"
                                                        ...
                                                        <tr>
                                                            <td colspan="2"
                                                                ...
                                                                <p
                                                                    ...
                                                                    @endif<br>
                                                                    {{-- <strong>Thời gian giao hàng dự kiến:</strong> Dự kiến giao hàng Thứ hai, 05/10 - không giao ngày Chủ Nhật  <br> --}}
                                                    ...
                                                    <tbody bgcolor="#eee"
                                                        ...
                                                        <tr>
                                                            <td align="left" style="padding:3px 9px" valign="top">
                                                                <span>{{ $order_info->name }}</span><br>
                                                            </td>
                                                            <td align="left" style="padding:3px 9px" valign="top">
                                                                <span> {{ number_format($order_info->price, 0, ',', '.') }}đ</span></td>
                                                            <td align="left" style="padding:3px 9px" valign="top">{{ $order_info->qty }}</td>
                                                            <td align="left" style="padding:3px 9px" valign="top">
                                                                <span>0đ</span></td>
                                                            <td align="right" style="padding:3px 9px" valign="top">
                                                                <span>{{ number_format($order_info->total, 0, ',', '.') }}đ</span></td>
                                                        </tr>
                                                        @endforeach
                                                    ...
                                                    <tfoot
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td align="right" style="padding:5px 9px">
                                                                <span>{{ number_format($total_price, 0, ',', '.') }}</span></td>
                                                        </tr>
                                                        <tr>
                                                        ...
                                                        <tr bgcolor="#eee">
                                                            ...
                                                            <td align="right" style="padding:7px 9px">
                                                                <strong><big><span>{{ number_format($total_price + 30000, 0, ',', '.') }}đ</span> </big> </strong></td>
                                                        </tr>
                                                    </tfoot>
                                                </table>
                                            </td>
                                        ...
                                        <tr>
                                            <td>&nbsp;
                                                ...
                                                <p
                                                    ...
                                                    <strong><a
                                                            href="https://manhhung.unitopcv.com/"
                                                            style="color:#00a3dd;text-decoration:none;font-size:14px"
                                                            rel="noreferrer" target="_blank"
                                                            data-saferedirecturl="https://manhhung.unitopcv.com/">HA
                                                            SHOP</a> </strong></p>
                                            </td>
                                        </tr>
                                    </tbody>
